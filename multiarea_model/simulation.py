...
class Simulation:
    ...
    def prepare(self):
        ...
        nest.resolution = self.params['dt']
        nest.total_num_virtual_procs = vp
        nest.overwrite_files = True
        nest.data_path = os.path.join(self.data_dir, 'recordings')
        nest.print_time = False
        nest.rng_seed = master_seed
    ...
    def create_recording_devices(self):
        ...
        self.spike_recorder = nest.Create('spike_recorder', 1, params=status_dict)
        ...
        if self.params['recording_dict']['record_vm']:
            ...
            label = '-'.join((self.label,
                              status_dict['label']))
            status_dict.update({'label': label})
            self.multimeter = nest.Create('multimeter', params=status_dict)
...
class Area:
    ...
    def create_populations(self):
        ...
        for pop in self.populations:
            ...
            local_nodes.V_m = nest.random.normal( 
